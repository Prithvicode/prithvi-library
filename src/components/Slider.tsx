...
const Slider: React.FunctionComponent = () => {
  ...
  return (
    <div className="w-full max-w-[850px] py-3 h-auto g3 mt-2 mb-3 justify-center overflow-hidden mx-auto [mask-image:linear-gradient(90deg,_transparent,_white_5%,_white_95%,_transparent)]">
      <ul className="w-max flex  flex-nowrap gap-4  animate-infinite-scroll ">
        {duplicateBooks.map((b, idx) => (
          <li
            key={b.id + Math.random() - idx} // unique duplicates.
